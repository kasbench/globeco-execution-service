...
class ExecutionControllerTest {
    ...
    void testCreateAndGetExecution() throws Exception {
        ExecutionPostDTO postDTO = new ExecutionPostDTO("NEW", "BUY", "NYSE", "SEC123456789012345678901", new BigDecimal("100.00"), new BigDecimal("10.00"), Integer.valueOf(1), Integer.valueOf(1));
